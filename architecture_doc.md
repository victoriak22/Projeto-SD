...
# Terminal 3: Cliente
docker logs -f messaging-client
...
- [Pub-Sub Pattern](https://zguide.zeromq.org/docs/chapter2/#Pub-Sub-Message-Envelopes)
- [XPUB-XSUB Proxy](https://zguide.zeromq.org/docs/chapter2/#The-Dynamic-Discovery-Problem)
